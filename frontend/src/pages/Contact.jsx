...
export default function Contact() {
  ...
  const [formData, setFormData] = useState({ name: '', email: '', subject: '', rating: '5 Stars - Highly Helpful', message: '' });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch('http://localhost:5000/api/feedbacks', {
        ...
        body: JSON.stringify({
          ...
          title: formData.subject || 'Student Feedback',
          rating: formData.rating || '5 Stars - Highly Helpful',
    ...
    setTimeout(() => {
      ...
      setFormData({ name: '', email: '', subject: '', rating: '5 Stars - Highly Helpful', message: '' });
    }, 4000);
  };
    ...
    <div className="container py-5 flex-grow-1 text-start">
      ...
      <div className="mb-5 pb-3 border-bottom" style={{ borderColor: 'var(--border-subtle)' }}>
        ...
        <h1 className="text-heading fw-bold display-6 m-0" style={{ fontFamily: 'var(--font-heading)', color: 'var(--brand-primary)', fontWeight: '800' }}>
          Platform Feedback & Inquiries
        </h1>
        <p className="text-muted-custom mt-2 mb-0">
          Share your feedback on ITI course lectures, syllabus modules, rate your learning experience, or reach out to our technical team.
        </p>
      </div>
      ...
      <div className="row g-4 align-items-stretch">
        ...
        <div className="col-12 col-lg-5">
          <div className="card glow-card p-4 h-100 d-flex flex-column" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-subtle)', borderRadius: '16px' }}>
            ...
            {/* Quick message form */}
            <h4 className="h6 fw-bold text-heading mb-3">Submit Feedback / Inquiry</h4>
            {formSubmitted ? (
                ...
                <div className="row g-2">
                  <div className="col-12 col-md-6">
                    <input 
                      ...
                      name="subject"
                      className="form-control" 
                      placeholder="Subject Topic / Feedback Title" 
