...
export default function LessonCard({ lesson, googleFormUrl }) {
  ...
  return (
    <ProfileCard
      name={t(lesson_title)}
      description={t(description) || t('vp.watchVisualDemo')}
      image={image}
      isVerified={hasGoogleForm}
      followers={1}
      following={0}
      followersLabel={t(mod) || 'module'}
      followingLabel={t(trade)?.toUpperCase() || 'trade'}
      followersIcon={Play}
