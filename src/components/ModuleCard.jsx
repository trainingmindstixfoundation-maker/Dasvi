...
export default function ModuleCard({ tradeName, semesterName, moduleName, lessonCount, googleFormUrl, index = 0 }) {
  const { t } = useLanguage();
  ...
  return (
    <div className="col-12 col-md-6 col-lg-4 mb-4 d-flex justify-content-center">
      ...
      <ProfileCard
        name={t(moduleName)}
        description={`${t(tradeName).toUpperCase()} • ${t(semesterName)}`}
        image={image}
        ...
        buttonLabel={t('moduleCard.description') || 'Explore Module →'}
